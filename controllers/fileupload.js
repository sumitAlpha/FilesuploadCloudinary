...
exports.imageUpload = async (req, res) => {
    try{
        ...
        console.log("Uploading to sumitfolder");
        const response = await uploadFileToCloudinary(file, "sumitfolder");
...
exports.imageSizeReducer = async (req,res) =>{
    try{
        ...
        //file format supported hai
        console.log("Uploading to sumitfolder");
        const response = await uploadFileToCloudinary(file, "sumitfolder",80);
        console.log(response);
